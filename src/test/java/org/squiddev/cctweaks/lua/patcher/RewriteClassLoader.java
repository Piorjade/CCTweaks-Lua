...
public class RewriteClassLoader extends ClassLoader {
	...
	private void addDefaultPrefixes() {
		...
		prefixes.add("org.squiddev.cctweaks.lua.patcher.runner.");
		prefixes.add("org.squiddev.cctweaks.lua.patch.");
	}
	...
	public void run(String source) throws Throwable {
		Class<?> runner = loadClass("org.squiddev.cctweaks.lua.patcher.runner.RunOnComputer");
		try {
	...
	public void runFile(String source) throws Throwable {
		Class<?> runner = loadClass("org.squiddev.cctweaks.lua.patcher.runner.RunOnComputer");
		try {
			Scanner s = new Scanner(getClass().getResourceAsStream(("/org/squiddev/cctweaks/lua/patcher/" + source + ".lua"))).useDelimiter("\\A");
